  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2">
        <Card>
          <h3 className="text-xl font-semibold">System Check</h3>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {Object.entries(checks).map(([k,v])=> (
              <motion.div key={k} initial={{opacity:0, y:8}} animate={{opacity:1, y:0}} transition={{delay:0.1}} className="flex items-center justify-between p-4 bg-white rounded-xl border">
                <div>
